package com.projekt.wyporzyczalnia.configurations;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.projekt.wyporzyczalnia.dto.common.ErrorResponseDto;
...
public class SecurityConfig {
    ...
    public SecurityConfig(@Value("${keycloak.resource:wyporzyczalnia-app}") String clientId,
